...
if(progressArr[ind]){
  return Math.floor((progressArr[ind].lectureCompleted/progressArr[ind].totalLectures)*100)
 } else{
  return 0
 }
  }
            ...
            <tr key={index} className='border-b border-gray-500/20'>
              <td className='md:px-4 pl-2 md:pl-4 py-3 flex items-center space-x-3'>
                ...
                <div className='flex-1'>
                  ...
                  <Line strokeWidth={2} percent={percentCalculator(progressArray, index)} className='bg-gray-300
                  rounded-full'/> 
                </div>
              </td>
              ...
              <td className='px-4 py-3 max-sm:text-right'>
                ...
                className = "px-3 sm:px-5 py-1.5 sm:py-2 md:px-6 md:py-3 bg-blue-600 text-xs sm:text-sm text-white rounded"> 
                  {progressArray[index].lectureCompleted / progressArray[index].totalLectures ===1? 'Completed':'On going'}</button>
              </td>
            </tr>
          ))}
        </tbody>
